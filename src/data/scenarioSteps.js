export const SCENARIO_STEPS = [
  ...
  { stageId: 'S2', title: '초기 공지 판단', narration: '고객센터 대기호 100+. 공지를 할까요?', choiceIds: ['S2_C1', 'S2_C2', 'S2_C3'] },
  { stageId: 'S2', title: '비로그인 공지', narration: '어드민 접속 불가 시 고객 공지 채널은?', choiceIds: ['S2_C4', 'S2_C5'] },
