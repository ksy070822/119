    ...
    <div className="min-h-screen bg-gradient-to-br from-sky-50 via-blue-50 to-indigo-50 flex flex-col items-center justify-center p-6 pt-12">
      ...
      <div className="w-full max-w-sm md:max-w-2xl mb-8">
        <div className="flex flex-col items-start text-left gap-3 md:gap-4">
          <div className="w-32 h-32 md:w-48 md:h-48 rounded-full bg-white shadow-lg flex items-center justify-center overflow-hidden border-4 border-sky-100">
            <img
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-slate-900 font-display">PetMedical.AI</h1>
          <p className="text-slate-500 text-lg md:text-xl">AI기반 반려동물 건강관리 플랫폼</p>
        </div>
      </div>
